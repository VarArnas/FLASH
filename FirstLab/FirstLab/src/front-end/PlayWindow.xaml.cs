...
public partial class PlayWindow : UserControl
{
    ...
    public PlayWindow(FlashcardSet flashcardSet, IMainFactories mainFactories, IServiceProvider serviceProvider)
    {
        InitializeComponent();
        this.serviceProvider = serviceProvider;
        this.mainFactories = mainFactories;
        this.flashcardSet = CloneFlashcardSet(flashcardSet);
        flashcardDesign = mainFactories.CreateDesign(false, false, incrementTextSize, decreaseTextSize);
    ...
    {
        FlashcardSet clonedSet = mainFactories.CreateFlashcardSet();
        clonedSet.Flashcards = serviceProvider.GetRequiredService<ObservableCollection<Flashcard>>();
