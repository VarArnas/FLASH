...
public class CustomizationErrors
{
    ...
    public CustomizationErrors(TextBox errorTextBox, string? NameOfFlashcardSet, FlashcardSet flashcardSet, ObservableCollection<FlashcardSet> SetsOfFlashcards, IServiceProvider serviceProvider) 
    {
